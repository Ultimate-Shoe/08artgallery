...
/* If a picture is selected, the information for name price title and text will be saved into local storage and 
 * then will be called on the buy page and receive page*/
